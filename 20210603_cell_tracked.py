...
#%% Context B data
set1 = cc_all_mice_1_B
set1_x = np.zeros(len(set1))
set2 = cc_all_mice_9_B
set2_x = np.zeros(len(set2))

# Split the data into training/testing sets
Y_train = set1[0:20] + set2[0:20]
Y_test = set1[-20:] + set2[-20:]

# Split the data into training/testing sets
X_train = set1_x[0:20] + set2_x[0:20]
X_test = set1_x[-20:] + set2_x[-20:]
