...
plt.plot([0, 1], [0.5 - ave_slope / 2, 0.5 + ave_slope / 2], 'k')
plt.suptitle(f'{condition} Context A')
plt.savefig(f"/Users/veronica_porubsky/GitHub/DG_graph_theory/scratch_files/visualization/20210603/{condition}_clustering_conA_matched_remove_extreme.png", transparent=True, dpi=300)
plt.show()
...
#%% Context A data
set1 = cc_all_mice_1_A
set2 = cc_all_mice_1_B

# Put into dataframe
df = pd.DataFrame({'A': set1, 'B': set2})
data = pd.melt(df)
