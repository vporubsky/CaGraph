...
for treatment_group_index in [0,1]:
    for mouse_id_index in range(len(all_untreated_files[treatment_group_index])):
        ...
        if treatment_group_index == 0:
            ...
            rand_con_A_size_subnetworks_D1.append(np.median(rand_len_connected_subnetworks_A)/num_neurons)
            rand_con_B_size_subnetworks_D1.append(np.median(rand_len_connected_subnetworks_B)/num_neurons)
            ...
            erdos_renyi_con_A_size_subnetworks_D1.append(np.median(erdos_renyi_len_connected_subnetworks_A)/num_neurons)
            erdos_renyi_con_B_size_subnetworks_D1.append(np.median(erdos_renyi_len_connected_subnetworks_B)/num_neurons)
            ...
            rand_con_A_size_subnetworks_D9.append(np.median(rand_len_connected_subnetworks_A)/num_neurons)
            rand_con_B_size_subnetworks_D9.append(np.median(rand_len_connected_subnetworks_B)/num_neurons)
            ...
            erdos_renyi_con_A_size_subnetworks_D9.append(np.median(erdos_renyi_len_connected_subnetworks_A)/num_neurons)
            erdos_renyi_con_B_size_subnetworks_D9.append(np.median(erdos_renyi_len_connected_subnetworks_B)/num_neurons)
