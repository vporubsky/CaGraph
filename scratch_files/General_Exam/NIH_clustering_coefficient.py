...
#%% Generate all-animal WT and Th distribution
WT_con_A_D1_cc_all = []
for mouse in WT_con_A_cc_D1:
    WT_con_A_D1_cc_all = WT_con_A_D1_cc_all + mouse

Th_con_A_D1_cc_all = []
for mouse in Th_con_A_cc_D1:
    Th_con_A_D1_cc_all = Th_con_A_D1_cc_all + mouse

WT_con_A_D9_cc_all = []
for mouse in WT_con_A_cc_D9:
    WT_con_A_D9_cc_all = WT_con_A_D9_cc_all + mouse

Th_con_A_D9_cc_all = []
for mouse in Th_con_A_cc_D9:
    Th_con_A_D9_cc_all = Th_con_A_D9_cc_all + mouse

WT_con_B_D1_cc_all = []
for mouse in WT_con_B_cc_D1:
    WT_con_B_D1_cc_all = WT_con_B_D1_cc_all + mouse

Th_con_B_D1_cc_all = []
for mouse in Th_con_B_cc_D1:
    Th_con_B_D1_cc_all = Th_con_B_D1_cc_all + mouse

WT_con_B_D9_cc_all = []
for mouse in WT_con_B_cc_D9:
    WT_con_B_D9_cc_all = WT_con_B_D9_cc_all + mouse

Th_con_B_D9_cc_all = []
for mouse in Th_con_B_cc_D9:
    Th_con_B_D9_cc_all = Th_con_B_D9_cc_all + mouse
...
plt.subplot(221)
sns.distplot(WT_con_A_D1_cc_all, hist=True, kde=True,
             bins=int(25), color = 'mistyrose',
             hist_kws={'edgecolor':'mistyrose'},
             kde_kws={'linewidth': 2})
sns.distplot(Th_con_B_D1_cc_all, hist=True, kde=True,
...
stat_lev = stats.ks_2samp(WT_con_A_D1_cc_all, Th_con_A_D1_cc_all)
plt.legend(['WT', 'Th-Cre'],loc='upper right')
plt.text(0.2, 5, f'KS P-value: {stat_lev.pvalue:.2e}')


plt.subplot(222)
sns.distplot(WT_con_B_D1_cc_all, hist=True, kde=True,
...
plt.xlabel('')
plt.ylabel('')
stat_lev = stats.ks_2samp(WT_con_B_D1_cc_all, Th_con_B_D1_cc_all)
plt.legend(['WT', 'Th-Cre'],loc='upper right')
plt.text(0.2, 5, f'KS P-value: {stat_lev.pvalue:.2e}')


plt.subplot(223)
sns.distplot(WT_con_A_D9_cc_all, hist=True, kde=True,
             bins=int(25), color = 'mistyrose',
             hist_kws={'edgecolor':'mistyrose'},
             kde_kws={'linewidth': 2})
sns.distplot(Th_con_A_D9_cc_all, hist=True, kde=True,
             bins=int(25), color = 'salmon',
             hist_kws={'edgecolor':'salmon'},
             kde_kws={"color": "salmon",'linewidth': 2})
plt.legend(['WT', 'Th-Cre'],loc='upper right')
...
stat_lev = stats.ks_2samp(WT_con_A_D9_cc_all, Th_con_A_D9_cc_all)
plt.text(0.2, 5, f'KS P-value: {stat_lev.pvalue:.2e}')

plt.subplot(224)
sns.distplot(WT_con_B_D9_cc_all, hist=True, kde=True,
             bins=int(25), color = 'turquoise',
             hist_kws={'edgecolor':'turquoise'},
             kde_kws={'linewidth': 2})
sns.distplot(Th_con_B_D9_cc_all, hist=True, kde=True,
             bins=int(25), color = 'teal',
             hist_kws={'edgecolor':'teal'},
             kde_kws={"color": "teal", 'linewidth': 2})
plt.title('D9 B')
...
stat_lev = stats.ks_2samp(WT_con_B_D9_cc_all, Th_con_B_D9_cc_all)
plt.text(0.2, 5, f'KS P-value: {stat_lev.pvalue:.2e}')
plt.legend(['WT', 'Th-Cre'],loc='upper right')
#plt.savefig(os.path.join(os.getcwd(), f"NIH_F31/clustering_coefficient.svg"), dpi=300, transparent=True)
plt.savefig(path_to_export + 'clustering_coefficient.png', dpi=300, transparent=True)
plt.show()
...
plt.ylabel('')
plt.title('D1')
plt.legend(['WT A', 'WT B'],loc='upper right')
...
stat_lev = stats.ks_2samp(WT_con_A_D9_cc_all, WT_con_B_D9_cc_all)
plt.text(0.2, 5, f'KS P-value: {stat_lev.pvalue:.2e}')


plt.subplot(223)
sns.distplot(Th_con_A_D1_cc_all, hist=True, kde=True,
             bins=int(25), color = 'salmon',
             hist_kws={'edgecolor':'salmon'},
             kde_kws={'linewidth': 2})
sns.distplot(Th_con_B_D1_cc_all, hist=True, kde=True,
             ...
             hist_kws={'edgecolor':'teal'},
             kde_kws={"color": "teal",'linewidth': 2})
plt.legend(['Th-Cre A', 'Th-Cre B'],loc='upper right')
plt.title('D1')
plt.xlabel('')
plt.ylabel('')

stat_lev = stats.ks_2samp(Th_con_A_D1_cc_all, Th_con_B_D1_cc_all)
plt.text(0.2, 5, f'KS P-value: {stat_lev.pvalue:.2e}')
...
stat_lev = stats.ks_2samp(Th_con_A_D9_cc_all, Th_con_B_D9_cc_all)
plt.text(0.2, 5, f'KS P-value: {stat_lev.pvalue:.2e}')
plt.savefig(path_to_export + 'a_b_clustering_coefficient.png', dpi=300, transparent=True)
plt.show()
